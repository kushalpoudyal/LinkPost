...
def about(request):
    """About page"""
    seo = {
        "title": "About QuickShip Logistics | Link Post",
        "description": "Learn the story, team, and values behind QuickShip Logistics powering Link Post parcel delivery.",
        "keywords": ["about link post", "quickship logistics", "parcel delivery team", "sustainable shipping"]
    }
    return render(request, 'core/aboutus.html', {"seo": seo})
...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        if not (name and email and message_text):
            messages.error(request, 'Please fill in required fields (name, email, message).')
        else:
            # Placeholder for future email / persistence logic
            messages.success(request, 'Your message has been received. We will reply shortly.')
...
# Mock tracking data (temporary – replace with real model/query later)
MOCK_TRACKING_DATA = [
    {
        "tracking_number": "LP123456789AU",
        "current_status": "In Transit",
        "last_updated": "2025-10-12 14:25",
        "origin": "Sydney NSW",
        ...
        "service": "Standard",
        "events": [
            ("2025-10-12 14:25", "Processed at Sydney Facility"),
            ("2025-10-12 09:10", "Picked up from sender"),
        ],
    },
    {
        "tracking_number": "LP987654321AU",
        "current_status": "Delivered",
        "last_updated": "2025-10-10 16:02",
        "origin": "Brisbane QLD",
        ...
        "service": "Express",
        "events": [
            ("2025-10-10 16:02", "Delivered - Signed by M.TAYLOR"),
            ("2025-10-10 08:40", "Out for delivery"),
            ("2025-10-09 19:05", "Arrived at Perth Facility"),
            ("2025-10-09 07:55", "Departed Adelaide Transit Hub"),
        ],
    },
    {
        "tracking_number": "LP555222111AU",
        "current_status": "Out for Delivery",
        "last_updated": "2025-10-15 08:12",
        "origin": "Canberra ACT",
        ...
        "service": "Same-Day",
        "events": [
            ("2025-10-15 08:12", "Courier loaded parcel"),
            ("2025-10-15 07:15", "At local delivery facility"),
        ],
    },
    {
        "tracking_number": "LP112233445AU",
        "current_status": "Label Created",
        "last_updated": "2025-10-15 09:31",
        "origin": "Hobart TAS",
        ...
        "service": "Eco",
        "events": [
            ("2025-10-15 09:31", "Label generated - awaiting pickup"),
        ],
    },
    {
        "tracking_number": "LP998877665AU",
        "current_status": "Processing",
        "last_updated": "2025-10-14 18:22",
        "origin": "Darwin NT",
        ...
        "service": "Standard",
        "events": [
            ("2025-10-14 18:22", "Parcel received at Darwin Facility"),
            ("2025-10-14 12:04", "Picked up from sender"),
        ],
    },
    {
        "tracking_number": "LP443322110AU",
        "current_status": "Delayed",
        "last_updated": "2025-10-13 11:47",
        "origin": "Adelaide SA",
        "destination": "Perth WA",
        "eta": "2025-10-19",
        "weight_kg": 12.0,
        "service": "Bulk",
        "events": [
            ("2025-10-13 11:47", "Weather delay - line haul rescheduled"),
            ("2025-10-12 22:30", "Departed Adelaide Facility"),
        ],
    },
    {
        "tracking_number": "LP770011223AU",
        "current_status": "In Transit",
        "last_updated": "2025-10-15 06:50",
        ...
        "service": "Express",
        "events": [
            ("2025-10-15 06:50", "Departed Brisbane Air Hub"),
            ("2025-10-14 21:05", "Processed at Brisbane Hub"),
        ],
    },
    {
        "tracking_number": "LP660055440AU",
        "current_status": "At Facility",
        "last_updated": "2025-10-15 05:30",
        ...
        "service": "Eco",
        "events": [
            ("2025-10-15 05:30", "Arrived at Melbourne Sorting Center"),
            ("2025-10-14 16:40", "Picked up from sender"),
        ],
    },
    {
        "tracking_number": "LP220099887AU",
        "current_status": "In Transit",
        "last_updated": "2025-10-14 23:10",
        "origin": "Perth WA",
        "destination": "Sydney NSW",
        "eta": "2025-10-19",
        "weight_kg": 8.3,
        "service": "Standard",
        "events": [
            ("2025-10-14 23:10", "Departed Perth Facility"),
            ("2025-10-14 15:15", "Processed at Perth Facility"),
        ],
    },
    {
        "tracking_number": "LP101010101AU",
        "current_status": "Delivered",
        "last_updated": "2025-10-11 10:05",
        "origin": "Sydney NSW",
        "destination": "Sydney NSW",
        "eta": "2025-10-11",
        "weight_kg": 0.4,
        "service": "Same-Day",
        "events": [
            ("2025-10-11 10:05", "Delivered - Left at reception"),
            ("2025-10-11 08:20", "Out for delivery"),
            ("2025-10-11 07:05", "Arrived at local facility"),
        ],
    },
]

def tracking(request):
    """Public tracking page with mock dataset"""
    query = request.GET.get('tn', '').strip().upper()
    result = None
    if query:
        for item in MOCK_TRACKING_DATA:
            if item["tracking_number"] == query:
                result = item
                break
    not_found = bool(query and not result)
    sample_numbers = [d["tracking_number"] for d in MOCK_TRACKING_DATA[:5]]
...
def export_data_pdf(request):
    ...
    table.setStyle(TableStyle([
        ...
        ('FONTSIZE', (0, 1), (-1, -1), 8),
        ('ALIGN', (0, 1), (-1, -1), 'CENTER'),  # ID column center
...
def customer_report_pdf(request):
    ...
    elements.append(Paragraph("Link Post - Personal Report", title_style))
    ...
    elements.append(Paragraph("Thank you for choosing Link Post - Making recycling easy and rewarding!", footer_style))
...
# Mock blog posts (replace with DB model later)
BLOG_POSTS = [
    {
        ...
        "date": "2025-10-10",
        "keywords": ["fragile packing", "parcel safety", "shipping tips"],
        "excerpt": "Practical steps and materials to protect glass, electronics, ceramics and more during transit.",
        "content": """
        <p>Packing fragile items starts with choosing a sturdy double‑walled box sized so contents cannot shift.</p>
        <p>Key steps: wrap each item individually (bubble wrap or foam sleeves), fill voids with kraft paper, avoid newspaper ink transfer, and add a 5cm cushioning layer on all sides.</p>
        <p>Label clearly with ‘Fragile – Handle With Care’ but rely on internal protection first. Consider insurance for high-value breakables.</p>
        """,
    },
    {
        "title": "Choosing the Right Courier Service in Australia",
        "slug": "choosing-the-right-courier-service",
        "category": "Shipping Guides",
        "date": "2025-10-08",
        "keywords": ["courier comparison", "express vs standard", "delivery speed"],
        "excerpt": "Speed, reliability, sustainability, coverage and price—how to balance the trade‑offs.",
        "content": """
        <p>Select service level by urgency: Same-Day for time‑critical metro transfers, Express for interstate urgency, Standard for cost balance, Eco for consolidated low‑carbon transport.</p>
        <p>Evaluate tracking transparency, delivery success rates, support hours, and carbon reporting if sustainability matters.</p>
        """,
    },
    {
        "title": "Customer Story: Scaling an Eco Brand With Smart Logistics",
        "slug": "customer-story-eco-brand-logistics",
        "category": "Customer Stories",
        "date": "2025-10-05",
        "keywords": ["customer story", "eco shipping", "scaling ecommerce"],
        "excerpt": "How a small eco shop cut fulfilment time 35% using Link Post batching & tracking tools.",
        "content": """
        <p>An emerging eco retailer reduced manual routing by adopting automated pickup scheduling and bulk label generation.</p>
        <p>Result: faster dispatch, fewer breakages, clearer delivery ETAs for end customers.</p>
        """,
    },
    {
        "title": "October Network Update & New Regional Routes",
        "slug": "october-network-update-regional-routes",
        "category": "News",
        "date": "2025-10-03",
        "keywords": ["network expansion", "regional delivery", "logistics news"],
        "excerpt": "New lanes activated for TAS and NT improving standard ETAs by up to 12 hours.",
        "content": """
        <p>We introduced optimized cross-dock timing and added evening line‑haul departures for regional corridors.</p>
        """,
    },
    {
        "title": "Sustainable Packaging: What Actually Matters",
        "slug": "sustainable-packaging-what-matters",
        "category": "Shipping Guides",
        "date": "2025-10-01",
        "keywords": ["sustainable packaging", "eco shipping", "green logistics"],
        "excerpt": "A quick hierarchy: reduce, right‑size, reuse, recyclable, compostable—why order matters.",
        "content": """
        <p>Right‑sizing reduces void fill and shipping weight, creating immediate emissions savings.</p>
        """,
    },
]

def _blog_seo(title=None, description=None, keywords=None):
    base_title = title or "Logistics Tips, News & Customer Stories"
    return {
        "title": f"{base_title} | Link Post",
        "description": description or "Guides, updates and stories on Australian parcel delivery, packaging, speed and sustainability.",
        "keywords": keywords or ["shipping", "courier", "delivery tips", "logistics", "australia"]
    }
...
def blog_detail(request, slug):
    ...
    seo = _blog_seo(title=post["title"], description=post["excerpt"], keywords=post["keywords"])
    return render(request, "core/blog.html", {
        "post": post,
        "seo": seo,
    })
...
def privacy(request):
    """Privacy policy page"""
    seo = {
        "title": "Privacy Policy | Link Post",
        "description": "Learn how Link Post collects, uses and protects personal data plus your rights (access, deletion, consent).",
        "keywords": ["privacy policy", "data protection", "gdpr rights", "link post privacy"]
    }
    return render(request, 'core/privacy.html', {"seo": seo})
