// Link Post - Complete Main JavaScript File
document.addEventListener("DOMContentLoaded", function () {
  console.log("🚀 Link Post System Initialized Successfully!");
...
function refreshDashboardStats() {
  fetch(window.location.href, {
    ...
    .then((html) => {
      ...
      const newStatCards = newDoc.querySelectorAll(
        ".card.bg-primary, .card.bg-success, .card.bg-info, .card.bg-warning"
      );
...
console.log("💻 Link Post System JavaScript Loaded Successfully!");

// Link Post - Main JavaScript File
document.addEventListener("DOMContentLoaded", function () {
  console.log("✅ Link Post System Loaded Successfully!");
